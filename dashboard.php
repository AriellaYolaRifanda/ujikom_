...
<head>
    ...
    $(document).ready(function() { //ready function
        ...
        $("#contentData").on("submit", "#formDos", function(e) {
            e.preventDefault();
            $.ajax({
        ...
        $("#contentData").on("click", "#deleteDos", function() {
        ...
        $("#contentData").on("click", "#editDos", function() {
            var kd_dosen = $(this).attr("value");
            $.ajax({
                url: 'dosen/edit.php',
                type: 'get',
        ...
        $("#contentData").on("submit", "#formEditDos", function(e) {
            e.preventDefault();
            $.ajax({
